  ...
  return (
    <div className="flex items-center justify-between font-poppins flex-col md:flex-row md:gap-x-5 ">
      ...
      <div className="flex items-center justify-center font-poppins flex-col space-y-2 ">
        ...
        <div className="font-bold text-[16px] dark:text-white">
          Select Food & Kitchen
        </div>
        <div className="text-gray-500  dark:text-white text-[14px] w-[200px] text-center text-sm/5">
      ...
      <div className="flex items-center justify-center font-poppins flex-col space-y-2 ">
        ...
        <div className="font-bold text-[16px] dark:text-white">Order & Pay</div>
        <div className="text-gray-500 text-[14px] w-[200px] text-center text-sm/5 dark:text-white">
          Lorem ipsum dolor sit amet, consec- tetuer adipisc.
        </div>
      </div>
