...
export default function Banner() {
  return (
    <div className="max-w-[100vw] h-[720px] md:h-[400px] lg:h-[600px] bg-[#fff7eb] space-y-2 pl-5 pt-5 relative flex md:flex-row flex-col md:justify-around lg:items-center">
      <img
        src={img1}
        alt="corn"
